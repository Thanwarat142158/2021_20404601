	...
	ui(new Ui::MainWindow)
{
	...
	connect( ui->pushButton_2, &QPushButton::released, this, &MainWindow::handleEditButton );
	connect( ui->pushButton_3, &QPushButton::released, this, &MainWindow::handleRemoveButton );
